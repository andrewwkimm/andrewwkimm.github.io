...
<PortfolioSection title="Consulting">
  <PortfolioItem
    ...
    beauty-related fields, building their data platform from scratch to support
    their rapidly growing business as they expand in multiple locations."
    links={[
  ...
  <PortfolioItem
    ...
    for partner organizations, a time-consuming process that took away from
    directly serving students. I developed a centralized web application that
    replaced the fragmented spreadsheet system with an intuitive interface
    accessible to non-technical audiences."
    additionalInfo="This web app serves not only the staff and students in At The Table,
    but also <a href='https://fairfuturesny.org' target='_blank'>Fair Futures</a>
    and students in
    <a href='https://www.cuny.edu/about/administration/offices/student-affairs/
    programs-services/foster-youth-college-success-initiative-fycsi/'
    target='_blank'>CUNY’s Foster Youth College Success Initiative</a>, among
...
<PortfolioSection title="Projects">
  <PortfolioItem
    ...
    embedded into it."
    additionalInfo="It was developed for myself and friends at a Discord community where
    there are many fans of K-pop and Anime, serving dozens of users weekly."
    links={[
  ...
  <PortfolioItem
    ...
    curiosity on video game trends. It sources data from RAWG's public API and
    is ultimately fed into a Streamlit web app to visualize the trends."
    links={[
